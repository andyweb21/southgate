    ...
    <div class="container">
      ...
      <nav class="main-nav float-right d-none d-lg-block">
        <ul>
          ...
          <li class="d-none d-sm-block"><a class="bg-success text-white rounded-pill" style="padding:4px 20px;font-weight:400;font-size:1.2rem;" href="whatsapp://send?text=Saya%20Tertarik%20Dengan%20The%20Prime%20Tower&phone=+6281311301275">0813 1130 1275</a></li>
        </ul>
      </nav><!-- .main-nav -->
      <div class="clearfix"></div>
    </div>
    <div class="d-block d-sm-none" style="background: white;border-top: 1px solid #eeeeee;border-bottom: 1px solid #eeeeee;padding: 15px 0;font-size: 1.3rem;">
      <div class="text-center">
        Whatsapp: <a class="bg-success text-white rounded-pill" style="padding:4px 20px;font-weight:400;" href="whatsapp://send?text=Saya%20Tertarik%20Dengan%20The%20Prime%20Tower&phone=+6281311301275">0813 1130 1275</a>
      </div>
    </div>
  </header><!-- #header -->
